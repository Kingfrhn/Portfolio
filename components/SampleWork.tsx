...
const webappBugs: BugDetail[] = [
  ...
  },
  {
    ...
    severity: 'MINOR',
    severityType: 'minor',
    title: 'Dropdown menu does not close when clicking outside the menu area',
    steps: '1. Log into dashboard.\n2. Click on the user profile avatar (top-right) to open dropdown.\n3. Click anywhere on the main content area outside the dropdown.',
    actual: 'Dropdown menu remains open and overlaps page content. User must click the avatar again to dismiss.',
    expected: 'Dropdown should close when user clicks any area outside the menu boundary (standard click-away dismiss behavior).',
    environment: 'Chrome 126, Firefox 128, Windows 11.',
    reproRate: '5 / 5.',
  },
  {
    id: 'BUG-W3',
